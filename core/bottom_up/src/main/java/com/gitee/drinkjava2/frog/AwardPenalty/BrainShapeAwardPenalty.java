...
public class BrainShapeAwardPenalty {
    private static byte[][][] brainShape = new byte[Env.BRAIN_XSIZE][Env.BRAIN_YSIZE][Env.BRAIN_ZSIZE];

    private static byte[][] pic= new byte[Env.BRAIN_YSIZE][Env.BRAIN_ZSIZE];
