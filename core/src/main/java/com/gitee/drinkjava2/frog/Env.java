...
public class Env extends JPanel {
    ...
    public static final int BRAIN_SIZE = 16; //脑立方边长大小，必须是2的幂数如4,8,16...，原因参见8叉树算法 
    ...
    public static EnvObject[] things = new EnvObject[] { new TwoInputJudge(0) };// 所有外界物体，如食物、测试工具都放在这个things里面
