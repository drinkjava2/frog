 ...
 * 
 * 
 * TwoInputOneFoodFullSenseJudge: 两点输入，4种排列组合中有一种是食物，青蛙全过程能感到甜苦味，经实测约2000轮后青蛙会进化出先尝一尝再决定咬还是不咬，利用味觉绕过了图像的模式识别，所以要改进测试条件，让味觉延迟于视觉，让它只能根据图像和记忆来预判咬不咬
 * TwoInputOneFoodDelaySenseJudge: 两点输入，4种排列组合中有一种是食物，甜苦味会延迟咬动作几个时间单位产生，强迫它必须根据之前形成的条件反射来预判决定咬不咬。开发中，未完成
 *  
 */
