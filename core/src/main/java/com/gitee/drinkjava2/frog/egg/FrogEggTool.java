	...
	public static void loadFrogEggs() {
		...
		if (errorfound) {
			...
			for (int j = 0; j < Env.FROG_EGG_QTY; j++) {
				...
				egg.organs.add(new FrogMoves.MoveUp().setXYZRN(800, 100, 500, r, "Up"));
				egg.organs.add(new FrogMoves.MoveDown().setXYZRN(800, 400, 500, r, "Down"));
				egg.organs.add(new FrogMoves.MoveLeft().setXYZRN(700, 250, 500, r, "Left"));
				egg.organs.add(new FrogMoves.MoveRight().setXYZRN(900, 250, 500, r, "Right"));
				egg.organs.add(new FrogEyes.SeeUp().setXYZRN(200, 300 + 90, 500, r, "SeeUp"));
				egg.organs.add(new FrogEyes.SeeDown().setXYZRN(200, 300 - 90, 500, r, "SeeDown"));
				egg.organs.add(new FrogEyes.SeeLeft().setXYZRN(200 - 90, 300, 500, r, "SeeLeft"));
				egg.organs.add(new FrogEyes.SeeRight().setXYZRN(200 + 90, 300, 500, r, "SeeRight"));
